      ...
      >
        <div className="form-group">
          ...
          <input
            ...
            id="articleHeading"
            onChange={(e) => {
              this.articleHeadingInputHandler(e);
            }}
            name="heading"
            placeholder="heading"
            value={this.state.articleHeadingInput}
            required
          />
        </div>
        <div className="form-group">
          ...
          <textarea
            ...
            id="description"
            onChange={(e) => {
              this.articleDescriptionInputHandler(e);
            }}
            name="description"
            placeholder="description"
            value={this.state.articleDescriptionInput}
            required
          />
        </div>
        <button
          type="submit"
          id="articles-article-creation-form-create-button"
            ...
            (!this.state.showArticleCreationForm ? (
              this.state.articles.length > 0 ? (
                ...
                <h3>
                  No Articles
                  <h5>
                    create one by clicking the New Article Button in the right
                  </h5>
                </h3>
              )
            ) : (
